...
const Header = ({ onNavigate }) => {
  ...
  return (
    <header
      ...
      className="fixed top-0 left-0 right-0 z-50 px-6 py-3 flex items-center justify-between bg-menu-green-dark/40 backdrop-blur-xl border-b border-white/10 safe-area-top"
    >
      <button
      ...
      <nav className="flex items-center gap-2 sm:gap-3">
        ...
        <a
          ...
          className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-menu-cream/20 text-menu-cream border border-menu-cream/30 hover:bg-menu-cream/35 hover:border-menu-cream/50 shadow-md hover:shadow-lg hover:scale-110 hover:-translate-y-0.5 active:scale-95 transition-all duration-200 ease-out"
        >
