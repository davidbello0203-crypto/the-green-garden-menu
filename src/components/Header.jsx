    ...
    >
      ...
      <nav className="flex items-center gap-2 sm:gap-3">
        ...
        <motion.a
          ...
          className="flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-menu-cream/20 text-menu-cream border border-menu-cream/30 hover:bg-menu-cream/35 hover:border-menu-cream/50 transition-colors shadow-md hover:shadow-lg"
